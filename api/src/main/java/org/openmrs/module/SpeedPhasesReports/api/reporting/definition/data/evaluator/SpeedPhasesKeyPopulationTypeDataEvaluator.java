 ...
 */
@Handler(supports=SpeedPhasesKeyPopulationTypeDataDefinition.class, order=50)
public class SpeedPhasesKeyPopulationTypeDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, (case fup.key_population_type when 105 then \"People who inject drugs\" when 160578 then \"Men who have sex with men\" when 160579 then \"Female sex Worker\" else \"\" end)\n" +
                "from visit v  \n" +
