 ...
 */
@Handler(supports=SpeedPhasesDateTransferredOutDataDefinition.class, order=50)
public class SpeedPhasesDateTransferredOutDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, d.transfer_date date_transferred_out \n" +
                "from visit v\n" +
                "inner join kenyaemr_etl.etl_patient_program_discontinuation d on date(d.visit_date) = date(v.date_started) and d.patient_id=v.patient_id\n" +
                "where discontinuation_reason=159492 and v.visit_id in(:visitIds)";
