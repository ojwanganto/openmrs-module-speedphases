...
import org.openmrs.module.SpeedPhasesReports.api.reporting.query.definition.DiscStudyVisitQuery;
...
@Component
@Builds({"speedPhasesReports.common.report.discReport"})
public class DiscReportBuilder extends AbstractReportBuilder {
    ...
    protected DataSetDefinition datasetColumns() {
        ...
        DiscStudyVisitQuery cd = new DiscStudyVisitQuery();
