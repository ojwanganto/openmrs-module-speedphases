 ...
 */
@Handler(supports=SpeedPhasesVisitEDDDataDefinition.class, order=50)
public class SpeedPhasesVisitEDDDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, fup.expected_delivery_date\n" +
                "from visit v  \n" +
