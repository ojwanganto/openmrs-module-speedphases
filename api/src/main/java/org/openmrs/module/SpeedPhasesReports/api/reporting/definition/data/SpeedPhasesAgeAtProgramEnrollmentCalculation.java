 ...
 */
public class SpeedPhasesAgeAtProgramEnrollmentCalculation extends AbstractPatientCalculation {

    @Override
    public CalculationResultMap evaluate(Collection<Integer> cohort, Map<String, Object> parameterValues, PatientCalculationContext context) {

        CalculationResultMap dateEnrolled = calculate(new SpeedPhasesEnrollmentDateCalculation(), cohort, context);
