 ...
 */
@Handler(supports=SpeedPhasesPartnerTestedDataDefinition.class, order=50)
public class SpeedPhasesPartnerTestedDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, (case fup.pwp_partner_tested when 1065 then \"Yes\" when 1066 then \"No\" when 1067 then \"Unknown\" when 1175 then \"N/A\" else \"\" end)\n" +
                "from visit v  \n" +
