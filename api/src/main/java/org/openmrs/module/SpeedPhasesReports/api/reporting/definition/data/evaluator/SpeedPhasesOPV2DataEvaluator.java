 ...
 */
@Handler(supports=SpeedPhasesOPV2DataDefinition.class, order=50)
public class SpeedPhasesOPV2DataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, 'Yes' as opv2 \n" +
                "from visit v \n" +
                "inner join kenyaemr_etl.etl_hei_immunization d on date(d.OPV_2) = date(v.date_started) \n" +
