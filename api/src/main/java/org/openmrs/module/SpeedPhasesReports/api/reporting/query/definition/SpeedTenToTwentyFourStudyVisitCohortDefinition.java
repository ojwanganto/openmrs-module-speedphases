...
public class SpeedTenToTwentyFourStudyVisitCohortDefinition extends BaseQuery<Visit> implements VisitQuery {

    @ConfigurationProperty
    private Date asOfDate;

    public SpeedTenToTwentyFourStudyVisitCohortDefinition() {
    }
