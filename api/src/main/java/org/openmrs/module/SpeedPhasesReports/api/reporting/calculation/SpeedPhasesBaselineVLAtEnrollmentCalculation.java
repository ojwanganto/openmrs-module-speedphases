 ...
 *
 */
public class SpeedPhasesBaselineVLAtEnrollmentCalculation extends AbstractPatientCalculation {
        ...
        for (Integer ptId : cohort) {
            ...
            if (enrollmentDate != null && weightObsResult != null && !weightObsResult.isEmpty()) {
                ...
                if (lastBeforeEnrollment != null) {
                    Integer viralLoadValue = lastBeforeEnrollment.getValueNumeric().intValue();
