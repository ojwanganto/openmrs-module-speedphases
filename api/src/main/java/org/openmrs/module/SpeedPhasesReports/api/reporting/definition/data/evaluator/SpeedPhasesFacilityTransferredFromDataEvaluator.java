 ...
 */
@Handler(supports=SpeedPhasesFacilityTransferredFromDataDefinition.class, order=50)
public class SpeedPhasesFacilityTransferredFromDataEvaluator implements PatientDataEvaluator {
    ...
    public EvaluatedPatientData evaluate(PatientDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select\n" +
                " d.patient_id, e.facility_transferred_from \n" +
                " from kenyaemr_etl.etl_patient_demographics d\n" +
                " left join kenyaemr_etl.etl_hiv_enrollment e on e.patient_id=d.patient_id and e.facility_transferred_from is not null and e.voided=0\n" +
