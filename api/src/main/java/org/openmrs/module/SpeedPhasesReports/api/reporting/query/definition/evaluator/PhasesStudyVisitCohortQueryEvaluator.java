 ...
 */
@Handler(supports=PhasesStudyVisitCohortDefinition.class)
public class PhasesStudyVisitCohortQueryEvaluator implements VisitQueryEvaluator {
    ...
    public VisitQueryResult evaluate(VisitQuery definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id \n" +
                ...
                "and datediff(v.date_started, p.birthdate) div 365.25 between 10 and 19\n" +
                "group by v.visit_id \n" +
