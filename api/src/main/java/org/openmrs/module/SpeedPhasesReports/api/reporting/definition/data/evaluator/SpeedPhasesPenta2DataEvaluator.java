 ...
 */
@Handler(supports=SpeedPhasesPenta2DataDefinition.class, order=50)
public class SpeedPhasesPenta2DataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, 'Yes' as penta2 \n" +
                "from visit v \n" +
                "inner join kenyaemr_etl.etl_hei_immunization d on date(d.DPT_Hep_B_Hib_2) = date(v.date_started) \n" +
