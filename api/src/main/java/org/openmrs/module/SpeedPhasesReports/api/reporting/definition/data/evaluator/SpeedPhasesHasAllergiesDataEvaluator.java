 ...
 */
@Handler(supports=SpeedPhasesHasAllergiesDataDefinition.class, order=50)
public class SpeedPhasesHasAllergiesDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, (case fup.has_known_allergies when 1 then 'Yes' when 2 then 'No' else '' end) has_allergies\n" +
                "from visit v  \n" +
