 ...
 */
@Handler(supports=SpeedPhasesCacxScreeningDataDefinition.class, order=50)
public class SpeedPhasesCacxScreeningDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, (case fup.cacx_screening when 703 then 'Positive' when 664 then 'Negative' when 1118 then 'Not done' when 1066 then 'Not done' when 1065 then 'Done' else '' end) cacx_screening\n" +
                "from visit v  \n" +
