 ...
 */
@Handler(supports=SpeedPhasesVisitARTAdherenceDataDefinition.class, order=50)
public class SpeedPhasesVisitARTAdherenceDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, (case fup.arv_adherence  when 159405 then \"Good\" when 163794 then \"Inadequate\" when 159407 then \"Poor\" else \"\" end)\n" +
                "from visit v  \n" +
