 ...
 */
@Handler(supports=SpeedPhasesStiPartnerNotificationDataDefinition.class, order=50)
public class SpeedPhasesStiPartnerNotificationDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, (case fup.sti_partner_notification when 1065 then 'Yes' when 1066 then 'No' else '' end) as has_chronic_illness \n" +
                "from visit v  \n" +
