 ...
 */
@Handler(supports=SpeedPhasesARTDateMedicallyEligibleDataDefinition.class, order=50)
public class SpeedPhasesARTDateMedicallyEligibleDataEvaluator implements VisitDataEvaluator {
