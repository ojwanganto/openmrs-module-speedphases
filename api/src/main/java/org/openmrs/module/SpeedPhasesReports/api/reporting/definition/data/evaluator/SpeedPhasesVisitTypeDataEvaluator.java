 ...
 */
@Handler(supports=SpeedPhasesVisitTypeDataDefinition.class, order=50)
public class SpeedPhasesVisitTypeDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, (case fup.visit_scheduled when 1 then \"Scheduled\" when 2 then 'Unscheduled' else \"\" end )\n" +
                "from visit v  \n" +
