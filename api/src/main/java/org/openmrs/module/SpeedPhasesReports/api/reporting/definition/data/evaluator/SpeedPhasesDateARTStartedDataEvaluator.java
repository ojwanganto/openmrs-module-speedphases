 ...
 */
@Handler(supports=SpeedPhasesDateARTStartedDataDefinition.class, order=50)
public class SpeedPhasesDateARTStartedDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, o.value_datetime"
                        ...
                        + " where o.concept_id in(159599) and v.visit_id in(:visitIds) ";
