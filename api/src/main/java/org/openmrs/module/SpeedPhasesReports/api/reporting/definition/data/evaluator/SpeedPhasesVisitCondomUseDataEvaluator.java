 ...
 */
@Handler(supports=SpeedPhasesVisitCondomUseDataDefinition.class, order=50)
public class SpeedPhasesVisitCondomUseDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, (case fup.condom_provided  when 1065 then \"Yes\" when 1066 then \"No\" when 1067 then \"Unknown\" else \"\" end)\n" +
                "from visit v  \n" +
