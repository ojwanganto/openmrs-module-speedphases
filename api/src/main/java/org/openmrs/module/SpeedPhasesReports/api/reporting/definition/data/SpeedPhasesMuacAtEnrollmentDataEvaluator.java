 ...
 */
@Handler(supports=SpeedPhasesMuacAtEnrollmentDataDefinition.class, order=50)
public class SpeedPhasesMuacAtEnrollmentDataEvaluator implements PatientDataEvaluator {
