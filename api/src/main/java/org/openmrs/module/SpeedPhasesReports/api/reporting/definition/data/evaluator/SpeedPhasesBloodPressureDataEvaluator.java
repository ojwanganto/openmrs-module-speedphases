 ...
 */
@Handler(supports=SpeedPhasesBloodPressureDataDefinition.class, order=50)
public class SpeedPhasesBloodPressureDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, concat_ws('/', systolic_pressure, diastolic_pressure) as pressure \n" +
                "from visit v  \n" +
