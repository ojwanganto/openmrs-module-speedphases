 ...
 */
@Handler(supports=DCOMDataDefinition.class, order=50)
public class DCOMDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, fup.differentiated_care \n" +
                "from visit v  \n" +
