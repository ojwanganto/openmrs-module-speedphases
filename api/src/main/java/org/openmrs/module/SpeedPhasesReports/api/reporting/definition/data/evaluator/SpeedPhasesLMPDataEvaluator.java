 ...
 */
@Handler(supports=SpeedPhasesLMPDataDefinition.class, order=50)
public class SpeedPhasesLMPDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, date(fup.last_menstrual_period)\n" +
                "from visit v  \n" +
