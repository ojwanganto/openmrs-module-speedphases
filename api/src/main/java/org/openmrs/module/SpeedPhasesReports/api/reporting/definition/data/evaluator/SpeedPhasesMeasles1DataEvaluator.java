 ...
 */
@Handler(supports=SpeedPhasesMeasles1DataDefinition.class, order=50)
public class SpeedPhasesMeasles1DataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, 'Yes' as measles \n" +
                "from visit v \n" +
                "inner join kenyaemr_etl.etl_hei_immunization d on date(d.Measles_rubella_1) = date(v.date_started) \n" +
