 ...
 */
@Handler(supports=DiscLastArtDurationDataDefinition.class, order=50)
public class DiscLastArtDurationDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, datediff(fup.next_appointment_date, fup.visit_date) \n" +
                "from visit v  \n" +
