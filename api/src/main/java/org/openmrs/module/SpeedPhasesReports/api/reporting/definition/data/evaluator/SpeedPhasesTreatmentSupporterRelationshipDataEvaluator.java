 ...
 */
@Handler(supports=SpeedPhasesTreatmentSupporterRelationshipDataDefinition.class, order=50)
public class SpeedPhasesTreatmentSupporterRelationshipDataEvaluator implements PatientDataEvaluator {
    ...
    public EvaluatedPatientData evaluate(PatientDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select\n" +
                "d.patient_id, (case e.relationship_of_treatment_supporter when 973 then \"Grandparent\" when 972 then \"Sibling\" when 160639 then \"Guardian\" when 1527 then \"Parent\" when 5617 then \"PARTNER OR SPOUSE\"\n" +
                " when 5622 then \"Other\" else \"\" end)  as treatmentSupporterRelationship\n" +
