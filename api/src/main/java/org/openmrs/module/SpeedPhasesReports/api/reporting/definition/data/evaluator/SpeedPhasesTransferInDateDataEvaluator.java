 ...
 */
@Handler(supports=SpeedPhasesTransferInDateDataDefinition.class, order=50)
public class SpeedPhasesTransferInDateDataEvaluator implements PatientDataEvaluator {
    ...
    public EvaluatedPatientData evaluate(PatientDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select\n" +
                " d.patient_id, e.transfer_in_date \n" +
                " from kenyaemr_etl.etl_patient_demographics d\n" +
                " left join kenyaemr_etl.etl_hiv_enrollment e on e.patient_id=d.patient_id and e.transfer_in_date is not null and e.voided=0\n" +
