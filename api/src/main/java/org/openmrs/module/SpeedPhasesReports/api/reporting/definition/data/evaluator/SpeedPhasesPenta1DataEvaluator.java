 ...
 */
@Handler(supports=SpeedPhasesPenta1DataDefinition.class, order=50)
public class SpeedPhasesPenta1DataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, 'Yes' as penta1 \n" +
                "from visit v \n" +
                "inner join kenyaemr_etl.etl_hei_immunization d on date(d.DPT_Hep_B_Hib_1) = date(v.date_started) \n" +
