 ...
 */
@Handler(supports=SpeedPhasesDateConfirmedHIVPositiveDataDefinition.class, order=50)
public class SpeedPhasesDateConfirmedHIVPositiveDataEvaluator implements PatientDataEvaluator {
    ...
    public EvaluatedPatientData evaluate(PatientDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select p.patient_id ,\n" +
                "  min(date(o.value_datetime)) as date_confirmed_positive\n" +
                " from patient p inner join  obs o on o.person_id = p.patient_id and o.voided=0  and o.concept_id =160554\n" +
