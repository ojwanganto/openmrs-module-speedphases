 ...
 */
@Handler(supports=SpeedPhasesBCGDataDefinition.class, order=50)
public class SpeedPhasesBCGDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, 'Yes' as bcg \n" +
                "from visit v \n" +
                "inner join kenyaemr_etl.etl_hei_immunization d on date(d.BCG) = date(v.date_started) \n" +
