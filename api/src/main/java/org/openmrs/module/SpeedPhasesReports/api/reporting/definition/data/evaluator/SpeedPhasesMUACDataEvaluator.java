 ...
 */
@Handler(supports=SpeedPhasesMUACDataDefinition.class, order=50)
public class SpeedPhasesMUACDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id, muac \n" +
                "from visit v  \n" +
